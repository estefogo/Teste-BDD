...
@tag
Feature: Cliente faz saque de dinheiro Como um cliente, eu gostaria de sacar dinheiro em caixa eletronico,
  ...
  Scenario: Cliente especial com saldo negativo
    ...
    Then Deve efetuar o saque e atualizar o saldo na conta para -300 reais
